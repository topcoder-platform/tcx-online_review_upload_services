...
final class Helper {
     ...
     *            the logger.
     * @throws IllegalArgumentException
     *             if str is <code>null</code> or empty string.
     */
     ...
     * @param key
     *            the key to get the property
     * @param defaultKey
     *            the default key to use
     * @param log
     *            the logger for logging purpose
     * @param cls
     ...
     *            the key to get the property
     * @param defaultKey
     *            the default property value if the key is missing
     * @param log
     *            the logger for logging purpose
     * @param cls
     *            the class type of the object to create
     ...
     *
     * @param namespace
     *            the namespace to get the property
     * @param key
     *            the key to search
     * @param defValue
     ...
     *            the logger
     * @param required
     *            boolean representing the property is required or optional
     * @return the property value
     * @throws ConfigurationException
     *             if any error occurs while reading configuration
     */
