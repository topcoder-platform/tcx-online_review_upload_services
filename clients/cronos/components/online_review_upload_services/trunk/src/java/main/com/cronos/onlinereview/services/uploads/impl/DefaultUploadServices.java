...
public class DefaultUploadServices implements UploadServices {
     ...
     */
    private Long[] getSubmitterRoleId(String[] roles) {
     ...
     * @throws InvalidUserException
     *             if there is no resource or roleId present
     */
    private Resource getResource(long projectId, long userId, String[] roles) throws InvalidUserException {
        ResourceManager manager = managersProvider.getResourceManager();
